...
| Course & Content | Automated feedback for each quiz attempt | `2.1 Description`, `3.1 Student`, `3.2 Instructor` | `UC-03`, `UC-07` | `QuizAttempt`, `AttemptAnswer` | Covered |
| Course & Content | Tips for improvement based on mistakes | `2.1 Description` | `UC-03` | `Question.explanation` | Covered |
...
| Assessment & Progress | Personalized progress and recommended next steps | `2.1 Description`, `3.1 Student` | `UC-03` | `ProgressRecord`, `QuizAttempt` | Covered |
...
| Reporting & Notifications | Assignment deadline notifications | `2.1 Description`, `3.4 Admin` | `UC-04`, `UC-09` | `Announcement`, `Notification` | Covered |
| Reporting & Notifications | New course content uploaded notifications | `2.1 Description`, `3.2 Instructor` | `UC-06`, `UC-09` | `Announcement`, `Notification` | Covered |
| Reporting & Notifications | Quiz score announcements | `2.1 Description`, `3.4 Admin` | `UC-03`, `UC-09` | `Notification` | Covered |
| Advisor Support | Student monitoring and follow-up | `2.1 Description`, `3.3 Academic Advisor` | `UC-08` | `AdvisorProfile`, `ProgressRecord`, `ActivityLog` | Covered |
| Admin Support | User management, moderation, announcements | `2.1 Description`, `3.4 Admin` | `UC-09` | `User`, `Announcement`, `Notification` | Covered |
